...
const Landing = () => {
  ...
  <div>
    ...
    <a href={'/produits'} className='bg-[rgba(77,77,129,1)] flex gap-[12px] w-[186px] font-[700] rounded-[10px] mx-auto text-[20px]
     h-[41px] text-white place-content-center place-items-center cursor-pointer my-[49px] max-lg:text-[18px] max-lg:w-[150px] max-lg:h-[38px] max-sm:text-[14px]
      max-sm:w-[110px] max-sm:h-[33px] max-sm:gap-2 hover:bg-[#434370]  '>
  {Lang.button}
