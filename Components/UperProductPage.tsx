...
const UperProductPage:React.FC<props> = (props) => {
    ...
    const [Item,setItem]=useState({nom:'String',
        promotion:0,
        prix:0,
        frais_livraison:0,
     img:'',
    ...
    useEffect(() => {
      ...
      setItem({nom:props.nom,promotion:props.promotion,prix:props.prix,frais_livraison:props.frais_livraison,img:props.img,Qte})  
      console.log(Item);
