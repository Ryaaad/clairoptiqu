...
const Card:React.FC<props> = (props) => {
    ...
    <div className={`flex place-content-center rounded-[10px]  bg-[rgba(255,52,57,0.3)] p-[2px] px-2 max-lg:px-[6px] max-lg:rounded-none ${props.discount!=0 ? 'visible' : 'invisible' } `}>
       { dir &&  <p className='text-[18px] text-[#E00409] max-xl:text-[16px] max-lg:text-[11px] max-sm:text-[10px] max-[550px]:text-[8px] ' >-{props.discount}%</p> }
       { !dir &&  <p className='text-[18px] text-[#E00409] max-xl:text-[16px] max-lg:text-[11px] max-sm:text-[10px] max-[550px]:text-[8px] ' >%{props.discount}-</p>} 
            </div>
         </div>
       { props.freeShiping == 0 &&  <div className='flex my-3 mt-2 place-content-center bg-[rgba(11,255,6,0.3)] w-[14vw] min-w-max px-2 rounded-[10px] 
       max-lg:rounded-[5px] max-sm:my-1 '>
         ...
         { props.freeShiping >0 &&  <div className='flex my-3 mt-2 place-content-center bg-[rgba(255,170,6,0.3)] w-[14vw] px-2
        ...
        { props.discount!=0 &&  <h1  className=' text-[rgba(77,77,129,0.6)] translate-y-[10%] font-[600] line-through '>{newprice} {currency} </h1> }
         </span>
