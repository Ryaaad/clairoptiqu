    ...
    <div className={`flex flex-col-reverse ${direction ? "md:flex-row" : "md:flex-row-reverse"} gap-5 bg-white p-2 md:p-4 lg:p-10`}>
        <div className="flex basis-[45%] flex-col gap-4 items-center justify-center p-2">
            ...
            <form action="" className="flex flex-col gap-10">
                ...
                <input className="py-2 text-[#4D4D81C9] border-b-[1px] border-b-[#4D4D81] outline-none " type="text" name="Prenom" id="" placeholder="Prénom" />
                <input className="py-2 text-[#4D4D81C9] border-b-[1px] border-b-[#4D4D81] outline-none " type="text" name="Adress" id="" placeholder="Adresse" />
                <input className="py-2 text-[#4D4D81C9] border-b-[1px] border-b-[#4D4D81] outline-none " type="text" name="Telephone" id="" placeholder="Numéro de téléphone" />
