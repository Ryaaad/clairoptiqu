        ...
        <div className="text basis-[70%]">
           ...
           <div className='flex w-full justify-between'>
            <div className='flex flex-col gap-2  py-2 text-[#4D4D81]'>
                    <h4 className='text-[16px] lg:text-[20px]'>{Translation.Card.Qte}   1</h4>
                    <p className="bg-[#FFAA064D] text-[#CE8902] font-semibold text-[15px] lg:text-lg rounded-lg sm:px-2 py-[1px]">{Translation.Card.Livraison.NotFree}</p>
