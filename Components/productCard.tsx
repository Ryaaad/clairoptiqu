            ...
            <div className="w-full">
                ...
                <div className="text bg-white p-2 py-1 rounded-bl-[20px] rounded-br-[20px]">
                    <div className="flex gap-2  justify-between items-center">
                        ...
                        {props.discount>0 && direction &&<p className="bg-[#ff343748] text-[#E00409] font-semibold text-[13px] rounded-sm px-1">-{props.discount}%</p>}
                        {props.discount>0 && !direction &&<p className="bg-[#ff343748] text-[#E00409] font-semibold text-[13px] rounded-sm px-1">{props.discount}%-</p>}
                    </div>
                    <div className="liv flex py-2">
                    ...
                    <div className="flex  items-center">
                        ...
                        {props.discount>0 && <p className="w-full text-[#4D4D8199] font-semibold text-[11px] line-through">{(props.price + (props.discount * props.price) / 100).toFixed(2) } {currency}</p>}
