const SideNav = () => {
    ...
    <div >
        <div className="hidden sm:block text-white bg-[#4D4D81]  sm:w-[160xp] lg:w-[200px] rounded-tl-2xl rounded-br-2xl min-h-[400px] h-[calc(100%-90px)] py-4 px-8">
            <h1 className="sm:text-xl lg:text-[24px] sm:mb-[20px] lg:mb-[30px] font-bold">Categorie:</h1>
        ...
        <div className="sm:hidden w-full flex items-center justify-center">
            ...
            <ul className="text-[16px] flex text-white gap-2" >
                <li className="bg-[#4D4D81] flex items-center py-2 px-[12px] rounded-tl-md rounded-br-md">Pour Homme</li>
                <li className="bg-[#4D4D81] flex items-center py-2 px-[12px] rounded-tl-md rounded-br-md">Pour Femme</li>
                <li className="bg-[#4D4D81] flex items-center py-2 px-[14px] rounded-tl-md rounded-br-md">Pour Enfant</li>
            </ul>
            </div>
        </div>
    </div> );
