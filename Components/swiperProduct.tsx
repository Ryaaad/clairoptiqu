    ...
    return ( 
           <div>
            ...
            >
              {
                data.map(card=>{
                 if(card.id != props.id) return  <SwiperSlide className='p-2'><ProductCard name={card.name} discount={card.discount} price={card.price} freeShiping={card.freeShiping} id={card.id} details={card.details}></ProductCard></SwiperSlide>
                })
              }
           ...
           <div className='pb-2 mb-2 sm:hidden block'>
            ...
            >
              {
                data.map(card=>{
                 if(card.id != props.id) return  <SwiperSlide className='p-1'><ProductCard name={card.name} discount={card.discount} price={card.price} freeShiping={card.freeShiping} id={card.id} details={card.details}></ProductCard></SwiperSlide>
                })
              }
            </Swiper>
           </div>
